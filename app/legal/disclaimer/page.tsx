...
export default function DisclaimerPage() {
  return (
    <article>
      ...
      <Section title="2. 메뉴 추천 서비스">
        <p>
          오늘 뭐 먹지? 서비스는 알고리즘 기반 메뉴 추천을 제공합니다.
        </p>
        <ul>
          <li>
            표시되는 영양 정보는 참고용 데이터로, 실제 음식의 영양 성분과
            다를 수 있습니다.
          </li>
          <li>
          ...
          <li>
            추천 식당 정보(추후 제공 예정)는 영업 시간·위치가 변경될 수
            있으며, 최신 정보를 보장하지 않습니다.
          </li>
        </ul>
      </Section>

      <Section title="3. 심리·성향 테스트">
        <p>
          이상형 동물상 테스트, MBTI 테스트, 감정 점수화 등 심리 관련 콘텐츠에
          대해 다음을 고지합니다.
        </p>
        <ul>
          <li>
            본 테스트는 공인된 심리 검사 도구가 아닌 엔터테인먼트 목적의
            콘텐츠입니다.
          </li>
          <li>결과가 개인의 성격, 심리 상태를 정확하게 반영하지 않을 수 있습니다.</li>
          <li>
      ...
      <Section title="4. 개인정보 및 위치 정보">
        <ul>
          ...
          <li>
            위치 기반 서비스(추후 제공 예정)에서 수집되는 위치 정보는
            서비스 이용 목적으로만 활용되며 저장되지 않습니다.
          </li>
        </ul>
      </Section>

      <Section title="5. 외부 링크 및 제3자 서비스">
        <p>
